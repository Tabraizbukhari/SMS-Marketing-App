...
class IndexController extends Controller
{
    ...
    {   
        if(Auth::user()->getUserSmsAPi->type == 'masking'){
            $data['api_url'] =  'http://sms1.synctechsol.com/api/sendmessage?email='.Auth::user()->email.'&message=testing&phone_number=090049124&orginator=masking';
        }else{
            $data['api_url'] =  'http://sms1.synctechsol.com/api/sendmessage?email='.Auth::user()->email.'&message=write&phone_number=090049124&orginator=99095';
        }
