            ...
            <div class="col-12 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">
                          <a href="{{ route('admin.contact.index') }}" class="btn btn-outline-dark float-right" >
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.contact.update', encrypt($contact->id)) }}" enctype="multipart/form-data"> @csrf
