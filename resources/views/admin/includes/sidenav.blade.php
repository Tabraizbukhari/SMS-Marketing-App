<nav id="sidebar" class="sidebar">
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="{{ route('admin.dashboard') }}">
            <span class="align-middle"> <img src="{{ url('logo/logo.png') }}" alt="synctechsol-logo" class="img-fluid"
                    width="132" height="132" /></span>
        </a>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{ route('admin.user.customer') }}">
            ...
            <li class="sidebar-item">
                ...
                <ul id="auth" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.message.create') }}">Compose
                            Message</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('admin.message.index') }}">Sent
                            Message</a></li>
                    <li class="sidebar-item"><a class="sidebar-link"
                            href="{{ route('admin.message.campaign') }}">Campaign</a></li>
