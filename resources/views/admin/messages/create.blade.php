                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Create New Message and Campaign
                          <a href="{{ route('admin.message.index') }}" class="btn btn-outline-dark float-right" >
                          <span class="align-middle" data-feather="chevron-left" ></span>back
                          </a>
                        </h2>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.message.store') }}" enctype="multipart/form-data"> @csrf
                            <div class="mb-3">
