            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.user.store', $type) }}"> @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" required name="register_as">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="Number" required class="form-control" step="any" name="cost"
                                            placeholder="Cost of per sms" value="{{ old('cost') }}">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                @else
                                    <div class="form-group">
                                        <label class="form-label">Sms Orginator code<span
                                                class="text-danger">*</span></label>
                                        <input type="text" required value="{{ isset($code) ? $code : '' }}" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('api_url') ?? (Auth::user()->adminApi->api_url ?? null) }}"
