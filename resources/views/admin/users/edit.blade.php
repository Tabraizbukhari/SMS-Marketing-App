                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.user.update', encrypt($user->id)) }}"> @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="api_name" placeholder="Enter user api name" value="{{ old('api_name')??$user->getUserSmsApi->api_username }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Api Password</label>
                                <input type="text" class="form-control" name="api_password" placeholder="Enter user api password" value="{{ old('api_password')??$user->getUserSmsApi->api_password }}">
                            </div>
