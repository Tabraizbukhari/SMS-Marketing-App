                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title text-capitalize">Add Users
                                <a href="{{ route('admin.user.reseller') }}" class="btn btn-outline-dark float-right">
                                    <span class="align-middle" data-feather="chevron-left"></span>back
                                </a>
                            </h2>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.user.update', encrypt($user->id)) }}"> @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text-danger">Enter the password if you want to change it, further skip it
                                    </small>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="Number" class="form-control" name="invoice_cost"
                                            placeholder="Monthly invoice cost"
                                            value="{{ old('invoice_cost') ?? $user->UserData->Invoice_charges }}">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="Number" class="form-control" step="any" name="cost"
                                            placeholder="Cost of per sms"
                                            value="{{ old('cost') ?? $user->UserData->price_per_sms }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">SMS<span class="text-danger">*</span></label>
                                        <input type="Number" required class="form-control" min="1" name="sms"
                                            placeholder="Number of sms"
                                            value="{{ old('sms') ?? $user->UserData->has_sms }}">
                                    </div>
                                </div>
                                @if ($user->type == 'masking')
                                    <div class="row form-group">
                                        ...
                                        <select class="select2 " name="masking[]" multiple
                                            data-placeholder="Select multiple masking">
                                            @foreach ($maskings as $mask)
                                                <option {{ in_array($mask->id, $userMasking) ? 'selected' : null }}
                                ...
                                @else
                                    <div class="form-group">
                                        <label class="form-label">Sms Orginator code<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{ isset($code) ? $code : '' }}" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('api_url') ?? $user->getUserSmsApi->api_url }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="api_name"
                                        placeholder="Enter user api name"
                                        value="{{ old('api_name') ?? $user->getUserSmsApi->api_username }}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Api Password</label>
                                    <input type="text" class="form-control" name="api_password"
                                        placeholder="Enter user api password"
                                        value="{{ old('api_password') ?? $user->getUserSmsApi->api_password }}">
                                </div>
