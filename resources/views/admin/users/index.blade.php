                          ...
                          <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                ...
                                <a href="{{ route('admin.user.customer', encrypt($u->id)) }}" class="dropdown-item">View Customers</a>
                                  ...
                                  <a href="{{ route('admin.user.blocked', encrypt($u->id)) }}" class="dropdown-item text-info">{{ ($u->is_blocked == 0)? 'Blocked' : 'un-blocked' }}</a>
                                  <a href="{{ route('admin.user.edit', encrypt($u->id)) }}" class="text-primary dropdown-item" >Edit</a>
                            ...
                            <div class="modal fade" id="addSMS{{$u->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <form method='post' action="{{ route('admin.transaction.amount.post', encrypt($u->id)) }}"> @csrf
                                    <div class="modal-body">
                                      <input class="form-control" required type="Number" value=""  max="{{ Auth::user()->has_sms }}" name="amount">
                                    </div>
