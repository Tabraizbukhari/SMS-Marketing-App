                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('user.customer.update', encrypt($user->id)) }}"> @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text-danger">Enter the password if you want to change it, further skip
                                        it </small>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('api_url') ?? ($user->getUserSmsApi->api_url ?? App\Models\Admin::first()->adminApi->api_url) }}"
